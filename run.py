...
def main():
	...
	parser.add_argument('--augmentation', help='path to the csv file of the additional infection data', required=False, type=str)
	...
	if args.action == 'train':
		train_and_evaluate_model(args.data, args.augmentation, args.config_path, Path(args.target_folder), args.calculate_feature_importances)
